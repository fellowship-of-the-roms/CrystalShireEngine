...
DEF ITEM_TABLE_ENTRIES                EQU 100
DEF ITEM_TABLE_LOCKED_ENTRIES         EQU  30
DEF ITEM_TABLE_CACHE_SIZE             EQU  16
DEF ITEM_TABLE_SAVED_RECENT_INDEXES   EQU   8
DEF ITEM_TABLE_MINIMUM_RESERVED_INDEX EQU $FF
