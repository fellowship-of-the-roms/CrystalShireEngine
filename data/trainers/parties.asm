...
BugsyGroup:
	...
	db 15
	dw YANMA
	dw TACKLE, QUICK_ATTACK, LEECH_LIFE, NO_MOVE
	db 15
	dw LEDIAN
	dw COMET_PUNCH, THUNDERPUNCH, FLASH, NO_MOVE
	db 17
	dw SCYTHER
	dw QUICK_ATTACK, LEER, FURY_CUTTER, PURSUIT
	db -1 ; end
...
KogaGroup:
	...
	db 49 ;44
	dw CROBAT
	dw DOUBLE_TEAM, FAINT_ATTACK, AERIAL_ACE, POISON_FANG
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 40 ;32
	dw VICTREEBEL
	dw CUT, TOXIC, SLUDGE_BOMB, RAZOR_LEAF
	db 40 ;new mon
	dw NOCTOWL
